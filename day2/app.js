...
;(function (global, factory) {
  ...
  const SELECTOR_DATA_TOGGLE$5 = '[azad="button"]'
  ...
  const SELECTOR_DATA_TOGGLE$4 = '[azad="collapse"]'
  const Default$a = {
    parent: null,
    toggle: true,
  }
  ...
  */
  ...
  const SELECTOR_DATA_TOGGLE$3 =
    '[azad="dropdown"]:not(.disabled):not(:disabled)'
  ...
  const SELECTOR_DATA_TOGGLE$2 = '[azad="modal"]'
  const Default$6 = {
    backdrop: true,
    focus: true,
    keyboard: true,
  ...
  const SELECTOR_DATA_TOGGLE$1 = '[azad="offcanvas"]'
  const Default$5 = {
    backdrop: true,
    keyboard: true,
    scroll: false,
  ...
  const SELECTOR_DATA_TOGGLE =
    '[azad="tab"], [azad="pill"], [azad="list"]' // TODO: could only be `tab` in v6
  const SELECTOR_INNER_ELEM = `${SELECTOR_INNER}, ${SELECTOR_DATA_TOGGLE}`
  const SELECTOR_DATA_TOGGLE_ACTIVE = `.${CLASS_NAME_ACTIVE}[azad="tab"], .${CLASS_NAME_ACTIVE}[azad="pill"], .${CLASS_NAME_ACTIVE}[azad="list"]`
